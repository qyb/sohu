...
public class TestRepeatBig {
	...
	public void testWrite() throws Exception {
		...
		System.out.println("write bigfile totaltimes: " + count);
		System.out.println("write bigfile successtimes: " + success);
	...
	public void logFileName() throws Exception {
		File file = new File(".\\logs\\filenames_big.log");
	...
	public void logWriteErrCode() throws Exception {
		File file = new File(".\\logs\\write_big_errcode.log");
		BufferedWriter out = new BufferedWriter(new FileWriter(file, false));
	...
	public void testRead() throws Exception {
		...
		long etime = System.currentTimeMillis();
		System.out.println("read bigfile totaltimes: " + fnID);
		System.out.println("read bigfile successtimes: " + success);
		System.out.println("total last: " + (etime - btime));
	...
	public void testDelete() throws Exception {
		...
		long etime = System.currentTimeMillis();
		System.out.println("delete bigfile totaltimes: " + fnID);
		System.out.println("delete bigfile successtimes: " + success);
	...
	public void testRecover() throws Exception {
		...
		long etime = System.currentTimeMillis();
		System.out.println("recover bigfile totaltimes: " + count);
		System.out.println("recover bigfile successtimes: " + success);
	...
	public void writeNow(boolean isASuccess, int taskID, int times,
		...
		String logname = null;
		if (isASuccess)
			logname = ".\\logs\\" + taskname + "_bigfile" + "_success" + ".log";
		else
			logname = ".\\logs\\" + taskname + "_bigfile" + "_failed"	+ ".log";
