...
PAGE_FETCH_DEFAULT_RETRY_DELAY = 2 # second
PAGE_FETCH_TIME_LIMIT = 3 * 60 # second

UPLOAD_ARTICLE_MAX_RETRIES = 10
UPLOAD_ARTICLE_DEFAULT_RETRY_DELAY = 2 # second 
UPLOAD_ARTICLE_TIME_LIMIT = 5 * 60 # second

DOWNLOAD_IMAGE_MAX_RETRIES = 5
DOWNLOAD_IMAGE_DEFAULT_RETRY_DELAY = 2 # second
DOWNLOAD_IMAGE_TIME_LIMIT = 5 * 60 # second

UPLOAD_IMAGE_MAX_RETRIES = 10
UPLOAD_IMAGE_DEFAULT_RETRY_DELAY = 2 # second
UPLOAD_IMAGE_TIME_LIMIT = 7 * 60 # second

DAYS_COOKIE_EXPIRES = 365 * 10 # day
